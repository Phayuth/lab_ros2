...
class PyKDLChainReader(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            String, "/ikenv/robot_description", self.urdf_callback, 10
        )
    ...
    def urdf_callback(self, msg):
        ...
        urdf_file_path_with_urdf_parser = (
            "/home/yuth/experiment/ICRA2024HandOverComp/urdf_file.urdf"
        )
        with open(
            urdf_file_path_with_urdf_parser, "w"
        ) as urdf_file_with_urdf_parser:
