...
class JointStatePublisher(Node):
    ...
    def __init__(self):
        ...
        self.publisher_joint1 = self.create_publisher(
            JointState, "/vs/joint_states", 10
        )
        self.publisher_joint2 = self.create_publisher(
            JointState, "/va/joint_states", 10
        )
        self.publisher_joint3 = self.create_publisher(
            JointState, "/vg/joint_states", 10
        )
    ...
    def publish_joint_states(self):
        ...
        joint_state_msg1.name = [
            "vs_shoulder_pan_joint",
            "vs_shoulder_lift_joint",
            "vs_elbow_joint",
            "vs_wrist_1_joint",
            "vs_wrist_2_joint",
            "vs_wrist_3_joint",
        ...
        joint_state_msg2.name = [
            "va_shoulder_pan_joint",
            "va_shoulder_lift_joint",
            "va_elbow_joint",
            "va_wrist_1_joint",
            "va_wrist_2_joint",
            "va_wrist_3_joint",
        ...
        joint_state_msg3.name = [
            "vg_shoulder_pan_joint",
            "vg_shoulder_lift_joint",
            "vg_elbow_joint",
            "vg_wrist_1_joint",
            "vg_wrist_2_joint",
            "vg_wrist_3_joint",
